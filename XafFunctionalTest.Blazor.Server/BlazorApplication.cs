...
namespace XafFunctionalTest.Blazor.Server {
    public partial class XafFunctionalTestBlazorApplication : BlazorApplication {
        public XafFunctionalTestBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafFunctionalTestBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
