...
using XafFunctionalTest.Blazor.Server.Services;
using DevExpress.Persistent.BaseImpl.PermissionPolicy;

namespace XafFunctionalTest.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XafFunctionalTestBlazorApplication>(Configuration);
            ...
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(XafFunctionalTest.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // Comment out the following line if using PermissionPolicyUser or a custom user type.
                options.UserLoginInfoType = typeof(XafFunctionalTest.Module.BusinessObjects.ApplicationUserLoginInfo);
